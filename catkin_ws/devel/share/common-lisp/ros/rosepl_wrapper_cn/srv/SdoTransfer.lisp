...
(cl:defmethod cl:initialize-instance :after ((m <SdoTransfer-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SdoTransfer-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosepl_wrapper_cn-srv:<SdoTransfer-request> is deprecated: use rosepl_wrapper_cn-srv:SdoTransfer-request instead.")))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:action-val is deprecated.  Use rosepl_wrapper_cn-srv:action instead.")
  (action m))
...
(cl:defmethod node-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:node-val is deprecated.  Use rosepl_wrapper_cn-srv:node instead.")
  (node m))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:index-val is deprecated.  Use rosepl_wrapper_cn-srv:index instead.")
  (index m))

(cl:ensure-generic-function 'subindex-val :lambda-list '(m))
(cl:defmethod subindex-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:subindex-val is deprecated.  Use rosepl_wrapper_cn-srv:subindex instead.")
  (subindex m))

(cl:ensure-generic-function 'write-val :lambda-list '(m))
(cl:defmethod write-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:write-val is deprecated.  Use rosepl_wrapper_cn-srv:write instead.")
  (write m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:data-val is deprecated.  Use rosepl_wrapper_cn-srv:data instead.")
  (data m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <SdoTransfer-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:size-val is deprecated.  Use rosepl_wrapper_cn-srv:size instead.")
  (size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SdoTransfer-request>)))
  ...
  "rosepl_wrapper_cn/SdoTransferRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SdoTransfer-request)))
  "Returns string type for a service object of type 'SdoTransfer-request"
  "rosepl_wrapper_cn/SdoTransferRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SdoTransfer-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SdoTransfer-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosepl_wrapper_cn-srv:<SdoTransfer-response> is deprecated: use rosepl_wrapper_cn-srv:SdoTransfer-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <SdoTransfer-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:error-val is deprecated.  Use rosepl_wrapper_cn-srv:error instead.")
  (error m))
...
(cl:defmethod is_ready-val ((m <SdoTransfer-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_cn-srv:is_ready-val is deprecated.  Use rosepl_wrapper_cn-srv:is_ready instead.")
  (is_ready m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SdoTransfer-response>)))
  ...
  "rosepl_wrapper_cn/SdoTransferResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SdoTransfer-response)))
  "Returns string type for a service object of type 'SdoTransfer-response"
  "rosepl_wrapper_cn/SdoTransferResponse")
