...
(cl:defmethod mm_x_pos-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_x_pos-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_x_pos instead.")
  (mm_x_pos m))

(cl:ensure-generic-function 'mm_y_pos-val :lambda-list '(m))
(cl:defmethod mm_y_pos-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_y_pos-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_y_pos instead.")
  (mm_y_pos m))

(cl:ensure-generic-function 'mm_z_pos-val :lambda-list '(m))
(cl:defmethod mm_z_pos-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_z_pos-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_z_pos instead.")
  (mm_z_pos m))

(cl:ensure-generic-function 'mm_x_orient-val :lambda-list '(m))
(cl:defmethod mm_x_orient-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_x_orient-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_x_orient instead.")
  (mm_x_orient m))

(cl:ensure-generic-function 'mm_y_orient-val :lambda-list '(m))
(cl:defmethod mm_y_orient-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_y_orient-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_y_orient instead.")
  (mm_y_orient m))

(cl:ensure-generic-function 'mm_z_orient-val :lambda-list '(m))
(cl:defmethod mm_z_orient-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_z_orient-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_z_orient instead.")
  (mm_z_orient m))

(cl:ensure-generic-function 'mm_w_orient-val :lambda-list '(m))
(cl:defmethod mm_w_orient-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:mm_w_orient-val is deprecated.  Use rosepl_wrapper_mn-msg:mm_w_orient instead.")
  (mm_w_orient m))

(cl:ensure-generic-function 'odom_lwheel-val :lambda-list '(m))
(cl:defmethod odom_lwheel-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:odom_lwheel-val is deprecated.  Use rosepl_wrapper_mn-msg:odom_lwheel instead.")
  (odom_lwheel m))

(cl:ensure-generic-function 'odom_rwheel-val :lambda-list '(m))
(cl:defmethod odom_rwheel-val ((m <PowerlinkOut>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-msg:odom_rwheel-val is deprecated.  Use rosepl_wrapper_mn-msg:odom_rwheel instead.")
  (odom_rwheel m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PowerlinkOut>)))
  ...
  (cl:format cl:nil "# Generated with epl_ros_generator.py~%~%# openPOWERLINK variables:~%string shm_name~%uint16 pid~%~%# xap.h variables:~%int64 mm_x_pos~%int64 mm_y_pos~%int64 mm_z_pos~%int64 mm_x_orient~%int64 mm_y_orient~%int64 mm_z_orient~%int64 mm_w_orient~%int64 odom_lwheel~%int64 odom_rwheel~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PowerlinkOut)))
  "Returns full string definition for message of type 'PowerlinkOut"
  (cl:format cl:nil "# Generated with epl_ros_generator.py~%~%# openPOWERLINK variables:~%string shm_name~%uint16 pid~%~%# xap.h variables:~%int64 mm_x_pos~%int64 mm_y_pos~%int64 mm_z_pos~%int64 mm_x_orient~%int64 mm_y_orient~%int64 mm_z_orient~%int64 mm_w_orient~%int64 odom_lwheel~%int64 odom_rwheel~%~%~%"))
