...
(cl:defmethod cl:initialize-instance :after ((m <SignalSync-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SignalSync-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosepl_wrapper_mn-srv:<SignalSync-request> is deprecated: use rosepl_wrapper_mn-srv:SignalSync-request instead.")))

(cl:ensure-generic-function 'do_add-val :lambda-list '(m))
(cl:defmethod do_add-val ((m <SignalSync-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-srv:do_add-val is deprecated.  Use rosepl_wrapper_mn-srv:do_add instead.")
  (do_add m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SignalSync-request>)))
  ...
  "rosepl_wrapper_mn/SignalSyncRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SignalSync-request)))
  "Returns string type for a service object of type 'SignalSync-request"
  "rosepl_wrapper_mn/SignalSyncRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SignalSync-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SignalSync-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosepl_wrapper_mn-srv:<SignalSync-response> is deprecated: use rosepl_wrapper_mn-srv:SignalSync-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SignalSync-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosepl_wrapper_mn-srv:success-val is deprecated.  Use rosepl_wrapper_mn-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SignalSync-response>)))
  ...
  "rosepl_wrapper_mn/SignalSyncResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SignalSync-response)))
  "Returns string type for a service object of type 'SignalSync-response"
  "rosepl_wrapper_mn/SignalSyncResponse")
