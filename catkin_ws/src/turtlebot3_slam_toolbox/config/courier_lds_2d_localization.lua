...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 240    -- 90
...
POSE_GRAPH.optimize_every_n_nodes = 10     -- 90,   0 means that we turn off global slam
...
POSE_GRAPH.optimization_problem.huber_scale = 7e-1    -- 1e1
...
POSE_GRAPH.global_constraint_search_after_n_seconds = 2.    -- 10.
